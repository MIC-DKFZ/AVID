...
class ArtefactRefineAction(PythonAction):
    ...
    def __init__(self, primaryInputs, generateCallable=None, indicateCallable=None, actionTag="ArtefactRefineAction",
        ...
        PythonAction.__init__(self, primaryInputs=primaryInputs, generateCallable=generateCallable,
                              indicateCallable=indicateCallable,
                              passOnlyURLs=False, actionTag=actionTag, alwaysDo=alwaysDo,
                              session=session, additionalActionProps=additionalActionProps,
                              propInheritanceDict=propInheritanceDict, **inputArgs)
...
class ArtefactRefineBatchAction(BatchActionBase):
    ...
    def __init__(self, inputSelector, actionTag="ArtefactRefine", session=None, additionalActionProps=None,
        ...
        BatchActionBase.__init__(self, actionTag=actionTag, actionClass=ArtefactRefineAction,
                                 primaryInputSelector=inputSelector,
                                 primaryAlias="primaryInputs", session=session,
