  ...
  def generateArtefact(self, reference = None, copyAdditionalPropsFromReference = True):
    ...
    for propID in self._propInheritanceDict:
      if not propID == artefactProps.ACTIONTAG \
        ...
        additionalProps[propID] = artefactHelper.getArtefactProperty(self._inputArtefacts[self._propInheritanceDict[propID]], propID)
    ...
    for propID in self._additionalActionProps:
      if not propID == artefactProps.ACTIONTAG \
        ...
        additionalProps[propID] = self._additionalActionProps[propID]
