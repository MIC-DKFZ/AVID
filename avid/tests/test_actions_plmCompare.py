...
class TestPlmCompare(unittest.TestCase):
    ...
    def test_simple_plm_compare_action(self):
      ...
      refFilePath = os.path.join(self.testDataDir, "plmCompare_Target_#0_vs_Moving_#1_ref.xml")
      ...
      refFilePath = os.path.join(self.testDataDir, "plmCompare_Target_#0_vs_Moving_#2_ref.xml")
