...
csvAdditionalData <- read.csv("@CSVADDITIONAL_FILE@", header=0, sep=";", as.is=TRUE)
png(file="../../result/case_1/@PNG_FILE@", height=700, width=1200)
par(mar=c(5,5,3,1))
...
plot(xRange, yRange, type = "n", xlab = "", ylab = "", cex.axis=2.0, cex.lab=2)
