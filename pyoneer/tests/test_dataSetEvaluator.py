...
class TestSelectors(unittest.TestCase):
  def setUp(self):
    ...
    self.instanceResultRef_2Criteria = {EvalInstanceDescriptor({'case': 'Case3'}): {'pyoneer.criteria.PropertyCriterion.timePoint.sum': 3.0,
                                                                                    'pyoneer.criteria.PropertyCriterion.timePoint': [1.0, 2.0],
                                                                                    'pyoneer.criteria.DurationCriterion.duration': 300.0},
                                        EvalInstanceDescriptor({'case': 'Case2'}): {'pyoneer.criteria.PropertyCriterion.timePoint.sum': 3.0,
                                                                                    'pyoneer.criteria.PropertyCriterion.timePoint': [1.0, 2.0],
                                                                                    'pyoneer.criteria.DurationCriterion.duration': 30.0},
                                        EvalInstanceDescriptor({'case': 'Case1'}): {'pyoneer.criteria.PropertyCriterion.timePoint.sum': 3.0,
                                                                                    'pyoneer.criteria.PropertyCriterion.timePoint': [1.0, 2.0],
    ...
    self.instanceResultRef_split = {EvalInstanceDescriptor({'case': 'Case1', 'timePoint': 1}): {'pyoneer.criteria.DurationCriterion.duration': 1.0},
                                    ...
                                    EvalInstanceDescriptor({'case': 'Case3', 'timePoint': 2}): {'pyoneer.criteria.DurationCriterion.duration': 200.0},
    ...
    self.resultRef_2Criteria = {'pyoneer.criteria.DurationCriterion.duration.max': 300.0,
                                'pyoneer.criteria.PropertyCriterion.timePoint.min': 1.0,
                                'pyoneer.criteria.PropertyCriterion.timePoint.sum.min': 3.0,
                                'pyoneer.criteria.PropertyCriterion.timePoint.sd': 0.5,
                                'pyoneer.criteria.PropertyCriterion.timePoint.mean': 1.5,
                                'pyoneer.criteria.PropertyCriterion.timePoint.max': 2.0,
                                'pyoneer.criteria.PropertyCriterion.timePoint.sum.sd': 0.0,
                                'pyoneer.criteria.MetricCriterionBase.FailedInstances': 0,
                                'pyoneer.criteria.PropertyCriterion.timePoint.sum.max': 3.0,
                                'pyoneer.criteria.DurationCriterion.duration.min': 3.0,
                                'pyoneer.criteria.PropertyCriterion.timePoint.sum.mean': 3.0,
