...
class TestDiceCriterion(unittest.TestCase):
  def setUp(self):
    ...
    self.namesRef = {'pyoneer.criteria.PlmDiceCriterion.TN.min': 'True Negatives (min)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.boundary.maxavg.mean': 'Maximum average Hausdorff distance boundary (mean)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.maxavg.min': 'Maximum average Hausdorff distance (min)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.boundary.maxavg.sd': 'Maximum average Hausdorff distance boundary (std dev)',
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.maxavg.max': 'Maximum average Hausdorff distance (max)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.maxavg.mean': 'Maximum average Hausdorff distance (mean)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.boundary.maxavg.max': 'Maximum average Hausdorff distance boundary (max)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.boundary.maxavg.min': 'Maximum average Hausdorff distance boundary (min)',
     'pyoneer.criteria.PlmDiceCriterion.SE.sd': 'Sensitivity (std dev)',
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.maxavg.sd': 'Maximum average Hausdorff distance (std dev)',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.boundary.maxavg': 'Maximum average Hausdorff distance boundary',
     ...
     'pyoneer.criteria.PlmDiceCriterion.hausdorff.maxavg': 'Maximum average Hausdorff distance',
