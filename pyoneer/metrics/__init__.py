...
class DefaultMetric (object):
  ...
  def __init__(self, metricCriteria, sessionDir, measureWeights = None, instanceDefiningProps = None,
    ...
    @param clearSessionDir: Indicates of the metric should remove all artefacts
